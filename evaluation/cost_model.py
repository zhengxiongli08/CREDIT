...
RTX5090_PROFILE = DeviceProfile(
    name="NVIDIA GeForce RTX 5090",
    sm_count=170,
    clock_ghz=2.41,
    hbm_bandwidth_gbps=1487.61,
    l2_capacity_bytes=96 * 1024 * 1024,
    l2_bandwidth_gbps=2807.02 * 2.41,
    local_smem_bytes_per_cycle_cta=20.89,
    local_smem_store_bytes_per_cycle_cta=33.01,
    dsmem_store_bytes_per_cycle_cta=2.14,
    max_shared_bytes_per_cta=101_376,
)


def shared_bytes_per_cta(spec: WorkloadSpec, cols: int, cluster_size: int) -> int:
...
def estimate(
    ...
    baseline_ms: float,
    rows: int | None = None,
    profile: DeviceProfile = RTX5090_PROFILE,
) -> ModelEstimate:
