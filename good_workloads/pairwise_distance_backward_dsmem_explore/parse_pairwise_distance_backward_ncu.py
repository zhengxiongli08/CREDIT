...
def main() -> int:
    cases = [
        ("block", RESULTS / "ncu_pairwise_distance_backward_block.csv"),
        ("cluster", RESULTS / "ncu_pairwise_distance_backward_cluster.csv"),
    ]
    rows = []
    ...
    out = RESULTS / "pairwise_distance_backward_ncu_summary.csv"
    fieldnames = [
        "variant",
        "cols",
        "rows",
