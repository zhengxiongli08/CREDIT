...
def main() -> int:
    cases = [
        ("block", RESULTS / "ncu_weighted_sum_backward_block.csv"),
        ("cluster", RESULTS / "ncu_weighted_sum_backward_cluster.csv"),
    ]
    rows = []
    ...
    out = RESULTS / "weighted_sum_backward_ncu_summary.csv"
    fieldnames = [
        "variant",
        "cols",
        "rows",
