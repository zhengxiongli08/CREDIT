...
ncu "${NCU_COMMON[@]}" -s 1 -c 1 \
  ...
  > "${RESULTS_DIR}/ncu_gated_standardize_block.csv"
echo "wrote ${RESULTS_DIR}/ncu_gated_standardize_block.csv"
...
ncu "${NCU_COMMON[@]}" -s 1 -c 1 \
  ...
  > "${RESULTS_DIR}/ncu_gated_standardize_cluster.csv"
echo "wrote ${RESULTS_DIR}/ncu_gated_standardize_cluster.csv"
