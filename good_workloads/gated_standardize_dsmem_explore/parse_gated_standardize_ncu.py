...
def main() -> int:
    cases = [
        ("block", RESULTS / "ncu_gated_standardize_block.csv"),
        ("cluster", RESULTS / "ncu_gated_standardize_cluster.csv"),
    ]
    rows = []
    ...
    out = RESULTS / "gated_standardize_ncu_summary.csv"
    fieldnames = [
        "variant",
        "cols",
        "rows",
