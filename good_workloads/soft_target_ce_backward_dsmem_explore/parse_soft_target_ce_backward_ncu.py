...
def main() -> int:
    cases = [
        ("block", RESULTS / "ncu_soft_target_ce_backward_block.csv"),
        ("cluster", RESULTS / "ncu_soft_target_ce_backward_cluster.csv"),
    ]
    rows = []
    ...
    out = RESULTS / "soft_target_ce_backward_ncu_summary.csv"
    fieldnames = [
        "variant",
        "cols",
        "rows",
