...
def main() -> int:
    cases = [
        ("block", RESULTS / "ncu_grad_centralized_clip_block.csv"),
        ("cluster", RESULTS / "ncu_grad_centralized_clip_cluster.csv"),
    ]
    rows = []
    ...
    out = RESULTS / "grad_centralized_clip_ncu_summary.csv"
    fieldnames = [
        "variant",
        "cols",
        "rows",
