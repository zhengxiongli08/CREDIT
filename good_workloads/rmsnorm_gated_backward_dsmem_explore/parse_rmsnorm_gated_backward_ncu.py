...
def main() -> int:
    cases = [
        ("block", RESULTS / "ncu_rmsnorm_gated_backward_block.csv"),
        ("cluster", RESULTS / "ncu_rmsnorm_gated_backward_cluster.csv"),
    ]
    rows = []
    ...
    out = RESULTS / "rmsnorm_gated_backward_ncu_summary.csv"
    fieldnames = [
        "variant",
        "cols",
        "rows",
