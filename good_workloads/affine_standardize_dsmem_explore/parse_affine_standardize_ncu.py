...
def main() -> int:
    cases = [
        ("block", RESULTS / "ncu_affine_standardize_block.csv"),
        ("cluster", RESULTS / "ncu_affine_standardize_cluster.csv"),
    ]
    rows = []
    ...
    out = RESULTS / "affine_standardize_ncu_summary.csv"
    fieldnames = [
        "variant",
        "cols",
        "rows",
