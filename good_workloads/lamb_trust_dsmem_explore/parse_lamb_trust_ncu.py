...
COLS = int(os.environ.get("COLS", "32768"))
...
def main() -> int:
    cases = [
        ("block", RESULTS / "ncu_lamb_trust_block.csv"),
        ("cluster", RESULTS / "ncu_lamb_trust_cluster.csv"),
    ]
    rows = []
    ...
    out = RESULTS / "lamb_trust_ncu_summary.csv"
    fieldnames = [
        "variant",
        "cols",
        "rows",
